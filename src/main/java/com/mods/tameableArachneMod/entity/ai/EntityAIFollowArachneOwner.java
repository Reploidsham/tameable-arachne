...
public class EntityAIFollowArachneOwner extends EntityAIBase
{
    ...
    public EntityAIFollowArachneOwner(EntityTameable animal, double p_i1625_2_, float p_i1625_4_, float p_i1625_5_)
    {
        this.thePet = animal;
